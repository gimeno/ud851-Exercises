...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadScaleFromPreferences(SharedPreferences sharedPreferences) {
        float scale = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_scale_multiplier_key),
                getString(R.string.pref_scale_multiplier_default)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        } else if (key.equals(getString(R.string.pref_scale_multiplier_key))) {
            loadScaleFromPreferences(sharedPreferences);
        }
    }
