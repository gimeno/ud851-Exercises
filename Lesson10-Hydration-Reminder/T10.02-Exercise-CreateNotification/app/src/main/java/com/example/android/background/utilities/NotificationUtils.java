...
public class NotificationUtils {
    ...
    public static final int REMAINDER_WATER_NOTIFICATION = 222;
    public static final int REMAINDER_WATER_PENDING_INTENT = 111;

    public static final String REMAINDER_WATER_CHANNEL = "reminder_water_channel";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(context, REMAINDER_WATER_CHANNEL)
        ...
        notificationManager.notify(REMAINDER_WATER_NOTIFICATION, builder.build());
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        return PendingIntent.getActivity(context,
                REMAINDER_WATER_PENDING_INTENT,
                intent,
