...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String JSON_RESULTS = "json_results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.containsKey(JSON_RESULTS)) {
                mSearchResultsTextView.setText(savedInstanceState.getString(JSON_RESULTS));
            }
        }
    }
